<?php
/**
 * Corporacy Theme Options Sanitization Functions
 *
 * @package Corporacy
 */
 ...
 */
function corporacy_sanitize_select( $input, $setting ) {
 ...
 */
function corporacy_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function corporacy_sanitize_post( $input ) {
 ...
 * @since 1.0
 */
function corporacy_sanitize_category_list( $input ) {
 ...
 *                    the setting default.
 */
function corporacy_sanitize_number_range( $number, $setting ) {
