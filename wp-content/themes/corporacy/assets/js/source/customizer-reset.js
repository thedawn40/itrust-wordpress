jQuery(function(s) {
    var e = [
        ["#customize-theme-controls", "all", "ct-reset", "ct-reset-main", corporacyCustomizerReset.confirm, corporacyCustomizerReset.reset]
    ];
    s.each(e, function(e, o) {
        ...
        c.on("click", function(e) {
            ...
            var t = {
                wp_customize: "on",
                action: "corporacy_customizer_reset",
                nonce: corporacyCustomizerReset.nonce.reset,
                section: o[1]
            };
