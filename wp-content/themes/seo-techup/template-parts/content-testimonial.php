...
?>
    ...
    <section id="testimonials" class="testimonials-5 creativo-testi">
      <div class="container">
        <div class="section-heading text-center">
			<?php if($techup_testimonial_subtitle) : ?>
				<span class="sm-title"><?php echo esc_html($techup_testimonial_subtitle); ?></span>
            <?php endif; ?>
			<?php if($techup_testimonial_title) : ?>
				<h3 class="bg-title"><?php echo esc_html($techup_testimonial_title); ?></h3>            
			<?php endif; ?>
		  </div>
